...
export const TocklerLogo = ({ color = '#8363ff', ...rest }: IconProps) => (
    <chakra.svg viewBox="0 0 180 180" color={color} {...rest}>
        <defs>
            <path
            ...
            <clipPath id="clipc6q7CKqgD5">
                <use xlinkHref="#aPcyKIjz" opacity="1" />
            </clipPath>
            <path
        ...
        <g>
            ...
            <g>
                <use xlinkHref="#c8gweQHD3" opacity="1" fill="currentColor" fillOpacity="1" />
            </g>
        </g>
    </chakra.svg>
);
